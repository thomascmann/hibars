...
function hibars2(settings){
  ...
  var margin = {top: 20, right: 20, bottom: 60, left: 65, legend: 0.15*chartwidth},
  ...
  var color = d3.scale.ordinal()
  	...
  	.range((function(){
  							if (levelsoffactor2 < 2) {return ["#599ad3", "#abdda4"];}
  							else {return colorpalettes.defaultcolors[levelsoffactor2];}
  						})()
  			);
...
function hibars3(settings){
  ...
  var color = d3.scale.ordinal()
    ...
    .range((function(){
                if (levelsoffactor3 < 2) {return ["#599ad3", "#abdda4"];}
                else {return colorpalettes.defaultcolors[levelsoffactor3];}
              })()
        );
      //.range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]);
...
function hibars4(settings){
  ...
  var color = d3.scale.ordinal()
    ...
    .range((function(){
                if (levelsoffactor4 < 2) {return ["#599ad3", "#abdda4"];}
                else {return colorpalettes.defaultcolors[levelsoffactor4];}
              })()
        );
      //.range(["#98abc5", "#8a89a6", "#7b6888", "#6b486b", "#a05d56", "#d0743c", "#ff8c00"]);
